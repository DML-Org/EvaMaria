...
<b>NOTE:</b>
1. MCF Filter X should have admin privillage.
...
- MCF Filter X Supports both url and alert inline buttons.
<b>NOTE:</b>
1. Telegram will not allows you to send buttons without any content, so content is mandatory.
2. MCF Filter X supports buttons with any telegram media type.
